<?php
	...
	$dbPassword = '';
	$dbDatabase = 'test';
	$appURI = 'online/online/app';
	$host = 'localhost';

	$adminConfig = array(
		'adminUsername' => "admin",
		'adminPassword' => "\$2y\$10\$fVDB01jgVMWg04aVUIzrI.obyNLPa3RKluySjzSRtKSX3eW.3imxy",
